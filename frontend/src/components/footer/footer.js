...
const Footer = () =>{
    ...
    return(
        <footer className={"bd-footer  mt-5 bg-dark"}>
            <div className="container-fluid text-md-left">
                <div className="row" style={LogoDiv}>
                    <div className="col-md-6 mt-md-0 mt-3">
                        <div className="d-flex flex-row" >
                            <h1 className={"text-white bg-dark"}>ICAF</h1>
                            <div style={fLogo}>
                                <p className={"text-white bg-dark"}>International Conference on Application Frameworks</p>
                            </div>                            
                        </div>
                        <div className="d-flex flex-row">
                            <div style={Icon}>
                    ...
                    <div className="col-md-3 mb-md-0 mb-3" style={FooterLinkDiv}>
                        <p className="text-muted bg-dark" style={SubHeadings}>Categories</p>
                    ...
                    <div className="col-md-3 mb-md-0 mb-3" style={FooterLinkDiv}>
                        <p className="text-muted bg-dark" style={SubHeadings}>Support</p>
